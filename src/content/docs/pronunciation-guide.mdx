...
description: Learn how Dutch sounds work — vowels, consonants, diphthongs, stress patterns, and spelling rules.
---
...
<DutchAudio />
<PageSummary wordCount={31} topics={["Pronunciation", "Tips", "Practice"]} />
...
1. **u / uu** — Not like English "oo." Round your lips and say "ee"
2. **ui** — The hardest Dutch sound. Practice with *huis* <Say text="huis" />, *tuin* <Say text="tuin" />, *uit* <Say text="uit" />
3. **g / ch** — The guttural sound. Start gentle, don't force it
4. **ij / ei** — These are the same sound! Don't try to make them different
5. **oe** — This is the "oo" sound (like "moon"), not "oh-eh"
6. **r** — Any style is fine. Don't stress about this one
7. **Final devoicing** — *hond* rhymes with "font," not "fond"
