...
| het | water | water |
| het | jaar | year |
| het | land | country/land |
| het | werk | work |
| het | geld | money |
| het | eten | food/eating |
| het | drinken | drinking/drink |
| het | brood | bread |
| het | vlees | meat |
| het | bier | beer |
| het | weer | weather |
...
| Dutch | English | Rule |
|-------|---------|------|
| de grote man | the tall man | de-word → add -e |
| een grote man | a tall man | de-word → add -e |
| de oude vrouw | the old woman | de-word → add -e |
| een oude vrouw | an old woman | de-word → add -e |
| het grote huis | the big house | het + het-word → add -e |
| een groot huis | a big house | een + het-word → NO -e |
| het kleine kind | the small child | het + het-word → add -e |
| een klein kind | a small child | een + het-word → NO -e |
| de grote huizen | the big houses | plural → add -e |
| grote huizen | big houses | plural → add -e |
