...
| Dutch | English | Example | IPA | Example Sentence |
|-------|---------|---------|-----|-----------------|
| on- | un- / not | onmogelijk (impossible) | `/ɔnˈmoː.ɣə.lək/` | Dat is onmogelijk! *(That's impossible!)* |
| ver- | change / away | verhuizen (to move house) | `/vərˈhœy̯.zən/` | Wij verhuizen naar Amsterdam. *(We're moving to Amsterdam.)* |
| be- | makes transitive | bespreken (to discuss) | `/bəˈspreː.kən/` | We bespreken het plan. *(We discuss the plan.)* |
| ge- | past participle | gemaakt (made) | `/ɣəˈmaːkt/` | Ik heb het gemaakt. *(I made it.)* |
| ont- | un-/de- | ontdekken (to discover) | `/ɔntˈdɛ.kən/` | Hij heeft Amerika ontdekt. *(He discovered America.)* |
| her- | re- | herhalen (to repeat) | `/hɛrˈhaː.lən/` | Kun je dat herhalen? *(Can you repeat that?)* |
| voor- | pre-/for- | voorkomen (to prevent) | `/ˈvoːr.koː.mən/` | We moeten dat voorkomen. *(We must prevent that.)* |
| aan- | on/to | aankomen (to arrive) | `/ˈaːn.koː.mən/` | De trein komt aan. *(The train arrives.)* |
| uit- | out/off | uitleggen (to explain) | `/ˈœy̯t.lɛ.ɣən/` | Kun je het uitleggen? *(Can you explain it?)* |
| op- | up/open | opbellen (to call) | `/ˈɔp.bɛ.lən/` | Ik bel je op. *(I'll call you.)* |
| af- | off/down | afspreken (to arrange) | `/ˈɑf.spreː.kən/` | We spreken om drie uur af. *(We arrange to meet at three.)* |
| mee- | along/with | meenemen (to take along) | `/ˈmeː.neː.mən/` | Neem je paraplu mee! *(Take your umbrella along!)* |
| terug- | back | terugkomen (to come back) | `/təˈrʏx.koː.mən/` | Ik kom morgen terug. *(I'm coming back tomorrow.)* |
